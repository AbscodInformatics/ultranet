...
const Testimonials = () => {
  ...
  return (
    <div
      data-aos="fade-up"
      data-aos-once="false"
      className="py-10  bg-[#004281] px-8 text-lg   text-white font-medium rounded transition duration-300"
    >
        ...
        >
          <SwiperSlide>
            <div
              data-aos="flip-down"
              data-aos-once="false"
              className="lg:max-w-[784px] border-[2px] mt-20 py-10 md:max-w-[716px] max-w-[400px] mx-auto  hover:bg-gradient-to-r from-[#DE466C] to-[#004281]  bg-[#004281] text-white font-medium  transition duration-300  lg:px-10 md:px-6 px-4  rounded-xl"
            >
