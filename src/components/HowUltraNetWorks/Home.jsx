      ...
      <div className="mx-[5%]">
        <div className=" py-7">
          ...
          <div className="flex md:w-[500px] my-7 mx-[2%] md:mx-auto text-xl rounded-xl bg-white h-14 md:h-16 justify-center gap-5 md:gap-10 items-center ">
            <button
              className={`tab hover:bg-gradient-to-r bg-[#004281] px-4 md:px-8 text-lg py-3 from-[#DE466C] to-[#004281] text-white font-medium rounded-full transition duration-300 ${
                activeTab === "monthly"
